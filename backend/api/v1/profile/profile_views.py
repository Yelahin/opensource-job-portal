...
from ..common.responses import ErrorResponseSerializer, MessageResponseSerializer
from .serializers import (
    ProfileSerializer,
    ProfileUpdateSerializer,
    ProfileUploadResponseSerializer,
)
...
class ProfileView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            200: OpenApiResponse(
                response=ProfileSerializer, description="Profile updated successfully"
            ),
            ...
            403: OpenApiResponse(
                description="Only job seekers can access this endpoint"
            ),
        },
        tags=["Profile"],
        examples=[
...
class ProfileUploadView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            200: OpenApiResponse(
                response=ProfileUploadResponseSerializer,
            ...
            403: OpenApiResponse(
                response=ErrorResponseSerializer,
                description="Only job seekers can access",
            ),
        },
        tags=["Profile"],
    )
...
class ResumeDeleteView(APIView):
    ...
    @extend_schema(
        ...
        responses={
            ...
            404: OpenApiResponse(
                response=ErrorResponseSerializer, description="No resume found"
            ),
        },
        tags=["Profile"],
    )
    def delete(self, request):
        ...
        if not user.resume:
            return Response(
                {"error": "No resume found"}, status=status.HTTP_404_NOT_FOUND
            )
