...
from . import analytics_views, auth_views, job_views, views
...
urlpatterns = [
    ...
    path(
        "team/invitations/<int:invitation_id>/resend/",
        views.resend_invitation,
        name="invitation-resend",
    ),
    path(
        "team/invitations/<int:invitation_id>/cancel/",
    ...
    path(
        ...
        analytics_views.get_application_analytics,
        name="application-analytics",
    ),
    path(
        "jobs/<int:job_id>/analytics/",
        analytics_views.get_job_application_analytics,
        name="job-analytics",
    ),
    # Job Form Metadata
    ...
    path(
        ...
        job_views.get_job_applicants,
        name="jobs-applicants",
    ),
    path(
        "jobs/<int:job_id>/applicants/<int:applicant_id>/",
        job_views.get_applicant_detail,
        name="applicant-detail",
    ),
    path(
        "jobs/<int:job_id>/applicants/<int:applicant_id>/update/",
        job_views.update_applicant_status,
