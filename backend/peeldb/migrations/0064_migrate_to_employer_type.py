...
def migrate_user_types_reverse(apps, schema_editor):
    ...
    print(
        f"⚠️  Warning: Reverse migration is lossy. {total} users migrated back to best-guess types."
    )
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            migrate_user_types_forward, reverse_code=migrate_user_types_reverse
        ),
    ]
