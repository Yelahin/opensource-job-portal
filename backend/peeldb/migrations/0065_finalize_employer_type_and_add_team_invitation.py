    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.EmailField(
                        max_length=254, help_text="Email address of person to invite"
                    ),
                ),
                (
                    "token",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=["company", "email"], name="unique_company_email_invitation"
            ),
        ),
        # Add index on token field for faster lookups
        migrations.AddIndex(
            model_name="teaminvitation",
            index=models.Index(fields=["token"], name="teaminv_token_idx"),
        ),
        # Add index on email + status for faster filtering
        migrations.AddIndex(
            model_name="teaminvitation",
            index=models.Index(
                fields=["email", "status"], name="teaminv_email_status_idx"
            ),
        ),
    ]
