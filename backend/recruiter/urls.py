...
urlpatterns = [
    ...
    url(
        ...
        RedirectView.as_view(
            url="http://localhost:5174/dashboard/jobs", permanent=False
        ),
        name="list",
    ),
    url(
        r"^profile/$",
        RedirectView.as_view(
            url="http://localhost:5174/dashboard/account", permanent=False
        ),
        name="profile",
    ),
    url(
        r"^login/$",
        RedirectView.as_view(url="http://localhost:5174/login", permanent=False),
        name="new_user",
    ),
